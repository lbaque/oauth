...
class _MyAppState extends State<MyApp> {
  ...
  // For a list of client IDs, go to https://auth.infor-business.com
  final String _clientId = 'interactive.public';
  final String _redirectUrl = 'com.duendesoftware.demo:/oauthredirect';
  final String _issuer = 'https://auth.infor-business.com';
  final String _discoveryUrl =
      'https://auth.infor-business.com/.well-known/openid-configuration';
  ...
  final AuthorizationServiceConfiguration _serviceConfiguration =
    ...
    authorizationEndpoint: 'https://auth.infor-business.com/connect/authorize',
    tokenEndpoint: 'https://auth.infor-business.com/connect/token',
    endSessionEndpoint: 'https://auth.infor-business.com/connect/endsession',
  );
  ...
  Future<void> _testApi(TokenResponse? response) async {
    final http.Response httpResponse = await http.get(
        Uri.parse('https://auth.infor-business.com/api/test'),
